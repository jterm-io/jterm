...
public record TerminalSize(int columns, int rows) {
    ...
    /**
     * Returns a copy of this size with the given row count.
     *
    ...
    /**
     * Returns true if the given position lies within this size.
     *
